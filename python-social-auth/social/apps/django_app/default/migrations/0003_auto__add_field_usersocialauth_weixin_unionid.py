...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSocialAuth.weixin_unionid'
        db.add_column('social_auth_usersocialauth', 'weixin_unionid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSocialAuth.weixin_unionid'
        db.delete_column('social_auth_usersocialauth', 'weixin_unionid')
    ...
    models = {
        ...
        'default.usersocialauth': {
            ...
            'created_on': ('django.db.models.fields.CharField', [], {'default': "'web'", 'max_length': '32', 'db_index': 'True'}),
            ...
            'weixin_unionid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True'})
        }
    }
