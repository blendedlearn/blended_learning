...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSocialAuth.created_on'
        db.add_column('social_auth_usersocialauth', 'created_on',
                      self.gf('django.db.models.fields.CharField')(default='web', max_length=32, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSocialAuth.created_on'
        db.delete_column('social_auth_usersocialauth', 'created_on')
