...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('default', ['UserSocialAuth'])
        ...
        db.send_create_signal('default', ['Nonce'])
        ...
        db.send_create_signal('default', ['Association'])
        ...
        db.send_create_signal('default', ['Code'])
